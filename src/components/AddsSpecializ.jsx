...
const AddsSpecializ = ({
  ...
  const [activeTab, setActiveTab] = useState("slots"); // "slots" or "intervals"
                            ...
                            {day.day_id &&
                              slots
                                ...
                                .map((slot, slotIndex) => (
                                  <span
                                    key={slotIndex}
                                    className="border-gray-300 w-32 border-[2px] py-2 text-sm text-center px-2 h-10 rounded-md flex justify-center items-center relative"
                                  >
