        ...
        {({ isValid, setFieldValue, values }) => (
          <Form>
                ...
                <div className="flex justify-center items-center gap-2">
                  <Field
                    ...
                    onChange={(e) => {
                      ...
                      updatedDaysWithSlots[dayIndex].day_id = e.target.value;
                    ...
                    newSlots
                      ...
                      .map((slot, slotIndex) => (
                        ...
                        >
                          ...
                          <IoMdCloseCircle
                            onClick={() => handleRemoveNewSlot(slotIndex)}
                            size={20}
            ...
            <div className="flex flex-col gap-4">
              {days.map((day) => {
                const daySlots = slots.filter((slot) => slot.day_id === day.id);
            ...
            {newSlots.length > 0 && (
              <Field
                type="text"
                name="waiting_time"
                onChange={(e) => setFieldValue("waiting_time", e.target.value)}
                className="border-[1px] bg-[#F4F4F6] rounded-xl py-3 px-5 h-[50px] focus:outline-none focus:border-primary w-full text-[#677294] my-3"
