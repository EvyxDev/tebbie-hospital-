...
import { getAllMedicalBooking } from "../../utlis/https";
...
const MedicalBookings = () => {
  ...
  const {
    ...
    queryKey: ["medical-bookings", startDate, endDate, search],
    enabled: true,
    queryFn: () => {
  ...
  const bookings = DataBooking?.items || [];
